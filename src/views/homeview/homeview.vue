    ...
    <div id="homeview">
        ...
        <div class="warning" v-show="!warningSelect">
            ...
            <div class="header">
                <div class="bg-header">
                    <div class="t-title">
                        <img src="../../assets/img/huanweiLogo.png" style="width: 50px;height: 50px;margin-top: 10px;"/>
                        数&nbsp;&nbsp;&nbsp;据&nbsp;&nbsp;&nbsp;展&nbsp;&nbsp;&nbsp;示&nbsp;&nbsp;&nbsp;平&nbsp;&nbsp;&nbsp;台
                    </div>
                    <div class="blackgroundImgGds">
                        ...
                        <div class="lineBox2">
                            ...
                            <div style="margin-top: 60px">
                                <div ref="zhexian"
                                     :style="{width: '700px', height: '300px',display:'flex',alignItems:'center'}"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <!-- 饼图 -->
                <div class="lineBox3">
                    <div class="carmsg">车&nbsp;&nbsp;&nbsp;辆&nbsp;&nbsp;&nbsp;考&nbsp;&nbsp;&nbsp;勤&nbsp;&nbsp;&nbsp;:
                    </div>
                    <div id="xxxd"
                         style="width: 400px;height:260px;display:flex;align-items:center;margin-left:20%;"></div>
                    <div>
                        <div ref="duibi"
                             :style="{width: '700px', height: '200px',display:'flex',alignItems:'center'}"></div>
                    </div>
                </div>
            </div>
            <!-- 弹框1 -->
