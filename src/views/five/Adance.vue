  ...
  <div id="bonus">
        ...
        <el-form :inline="true" :model="shifts">
          ...
          <div>
            ...
            <span slot="footer" class="dialogLogin">
              <el-button type="primary" @click="deleteAdd" size="small" class="butdelete">取消</el-button>
              <el-button type="primary" @click="addAttendance" size="small">确认</el-button>
            </span>
          </div>
        </el-form>
      </el-dialog>
    ...
    >
      ...
      <el-table-column align="center" prop="picpath" label="现场照片" width>
        <template slot-scope="scope">
          <span v-if="scope.row.picpath" style="color:blue" @click="photos(scope.row, scope.$index)">查看照片</span>
  ...
  methods: {
    ...
    addAttendance() {
      let _date = {
        ...
        worktime: `${this.addtimeout}-${this.addtimeoff}`,
        relaxtime: `${this.dateone}-${this.datetown}`,
